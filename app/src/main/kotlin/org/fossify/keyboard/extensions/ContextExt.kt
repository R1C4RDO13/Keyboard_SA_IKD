...
val Context.ikdAggregator: IkdAggregator
    get() = IkdAggregator(ikdDB)

val Context.ikdSessionStatsLoader: IkdSessionStatsLoader
    get() = IkdSessionStatsLoader(ikdDB)
...
val Context.ikdSensorAggregator: IkdSensorAggregator
    get() = IkdSensorAggregator(ikdDB)

val Context.ikdHabitsAggregator: IkdHabitsAggregator
    get() = IkdHabitsAggregator(ikdDB)

val Context.ikdActivityAggregator: IkdActivityAggregator
    get() = IkdActivityAggregator(ikdDB)
...
val Context.ikdQualityAggregator: IkdQualityAggregator
    get() = IkdQualityAggregator(ikdDB)

val Context.ikdBadgeEvaluator: IkdBadgeEvaluator
    get() = IkdBadgeEvaluator(ikdDB)
