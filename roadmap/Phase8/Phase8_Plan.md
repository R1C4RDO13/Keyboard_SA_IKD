...
**Status:** Implemented. Phase 8 core merged via `feat/phase8-mood-bar`; 8.1 UI polish via `fix/phase8-ui-polish` (see [Section 12](#12-post-merge-ui-polish-phase-81)). Sub-phases **8.2** (UX polish — toggles, capsule, chat-bubble; [§13](#13-mood-bar-ux-polish-phase-82)), **8.3** ([`Phase8.3_Plan.md`](Phase8.3_Plan.md)), **8.4** (dance + haptic — [`Phase8.4_Plan.md`](Phase8.4_Plan.md)) and **8.5** (collapsible right-anchored chip — [`Phase8.5_Plan.md`](Phase8.5_Plan.md)) all landed directly on `main`. (Phase 13 later moved the bar to the trailing edge.)
